...
export default function Welcome() {
    ...
    return (
        <div className="min-h-screen lg:h-screen w-full bg-transparent flex flex-col items-center justify-center p-4 relative overflow-x-hidden overflow-y-auto lg:overflow-hidden custom-scrollbar">
            {/* Background Elements */}
