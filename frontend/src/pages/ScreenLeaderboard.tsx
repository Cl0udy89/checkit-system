...
// Pure CSS radial gradient – zero JS, zero GPU blur-filter cost.
// Replaces the 3× motion.div orbs that had blur-[120px]/[150px]/[100px] running
// a continuous Framer Motion rAF loop (very expensive on low-end APU hardware).
const StaticBackground = memo(() => (
    <div
        className="absolute inset-0 pointer-events-none z-0"
        style={{
            background:
                'radial-gradient(ellipse 55% 55% at 12% 12%, rgba(99,102,241,0.12) 0%, transparent 68%),' +
                'radial-gradient(ellipse 65% 65% at 88% 88%, rgba(243,234,95,0.08) 0%, transparent 68%)',
        }}
    />
))
